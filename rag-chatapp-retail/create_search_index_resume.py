...
def create_index_definition(index_name: str, model: str) -> SearchIndex:
    ...
    fields = [
        SimpleField(name="id", type=SearchFieldDataType.String, key=True, analyzer_name="keyword"), # SimpleField is used to define basic fields in a search index. These fields can store simple data types such as strings, integers, booleans, etc.
        ...
        SearchableField(name="file_name", type=SearchFieldDataType.String, retrievable=True),
        ...
        vectorizers=[  
            AzureOpenAIVectorizer(  
                ...
                parameters=AzureOpenAIVectorizerParameters(  
                    resource_url=os.environ.get("AZURE_OPENAI_ENDPOINT", "https://<your-openai-resource>.openai.azure.com"),  
                    deployment_name="text-embedding-ada-002",
                    model_name="text-embedding-ada-002",
                    api_key=os.environ.get("AZURE_OPENAI_KEY", "<YOUR_AZURE_OPENAI_KEY>"),
                ),
            ),  
        ],  
    )
