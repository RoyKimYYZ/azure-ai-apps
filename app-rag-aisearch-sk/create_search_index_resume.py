...
import os
# This is Hub based project 
from azure.ai.projects import AIProjectClient # azure-ai-projects==1.0.0b10 https://learn.microsoft.com/en-us/azure/ai-foundry/quickstarts/get-started-code?tabs=azure-ai-foundry&pivots=hub-project#set-up-your-development-environment
...
project = AIProjectClient(
    endpoint=os.environ["AIPROJECT_ENDPOINT"],  # Replace with your endpoint
    credential=DefaultAzureCredential(),
    subscription_id="f1a72634-3a90-4cdb-a6d6-069cf5115068", #os.environ["AIPROJECT_SUBSCRIPTION_ID"],
    resource_group_name="rk-ai", #os.environ["AIPROJECT_RESOURCE_GROUP_NAME"],
    project_name="rk-aihub-project" #os.environ["AIPROJECT_PROJECT_NAME"],
)
...
def create_index_from_csv(index_name, csv_file):
    ...
    index_definition = create_index_definition(index_name, model=os.environ["EMBEDDINGS_DEPLOYMENT"])
    index_client.create_index(index_definition)

    # create documents from the products.csv file, generating vector embeddings for the "description" column
    docs = create_docs_from_csv(path=csv_file, content_column="resume", model=os.environ["EMBEDDINGS_DEPLOYMENT"])
